export const MAJOR_BASE_BUILD_RANGES_METERS = Object.freeze([85, 120, 160, 205, 255]);
export const FIELD_BASE_BUILD_RANGES_METERS = Object.freeze([50, 75, 105, 140, 180]);
...
export function majorBaseBuildRange(level) {
  return MAJOR_BASE_BUILD_RANGES_METERS[normalizedConstructionLevel(level)];
}

export function fieldBaseBuildRange(level) {
  return FIELD_BASE_BUILD_RANGES_METERS[normalizedConstructionLevel(level)];
}
