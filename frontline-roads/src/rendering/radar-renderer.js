...
function drawGrid(context, width, height, center, preferences = {}) {
  ...
  context.save();
  context.strokeStyle = 'rgba(48, 224, 191, 0.065)';
  context.lineWidth = 1;
...
function drawRings(context, width, height, center, preferences = {}) {
  ...
  context.save();
  context.lineWidth = 1;
  context.strokeStyle = 'rgba(66, 255, 210, 0.14)';
  ...
  context.strokeStyle = 'rgba(96, 255, 224, 0.105)';
  ...
  context.strokeStyle = 'rgba(112, 255, 226, 0.3)';
...
function drawScreenTexture(context, width, height, preferences = {}) {
  ...
  vignette.addColorStop(0.72, 'rgba(0,8,8,0.07)');
  vignette.addColorStop(1, preferences.quality === 'minimal' ? 'rgba(0,5,7,0.48)' : 'rgba(0,5,7,0.62)');
