...
function makeCombatDocument() {
  const ids = ['combatTools', 'cityHp', 'enemyCount', 'civilizationLevel', 'contextPanel', 'contextTitle', 'contextText', 'contextActions', 'threatStatus', 'threatLevel', 'threatDetail', 'nearestThreat', 'activeDefenses', 'activeWaves'];
