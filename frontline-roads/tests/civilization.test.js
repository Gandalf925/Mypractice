...
test('every civilization project uses implemented requirements and fits the unlocked settlement slots', () => {
  const supportedBuildings = new Set([
    ...
    'ironDefenses', 'ironDefenseKinds', 'gate4',
    'steelDefenses', 'steelDefenseKinds', 'gate5',
  ...
  const supportedProgress = new Set([
    ...
    'tinCampsCaptured', 'ironCampsCaptured', 'selfProducedSteel', 'selfProducedMechanism',
    'generation5CommandersDefeated', 'generation6CommandersDefeated', 'machineWorksCaptured', 'cityHpStreak'
  ]);
