...
test('civilization build ranges use explicit bounded progression instead of exponential doubling', () => {
  assert.deepEqual(MAJOR_BASE_BUILD_RANGES_METERS, [85, 120, 160, 205, 255, 285, 315, 345]);
  assert.deepEqual(FIELD_BASE_BUILD_RANGES_METERS, [50, 75, 105, 140, 180, 205, 230, 255]);
