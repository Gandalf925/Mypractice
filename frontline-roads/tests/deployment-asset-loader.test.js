...
test('asset loader starts with the current application-relative stylesheet', async () => {
  ...
  assert.equal(requested[0], 'https://example.com/Mypractice/frontline-roads/src/styles/app.css?v=0.33.4');
});
...
test('asset loader recovers a legacy fr path through the canonical frontline-roads directory', async () => {
  ...
  assert.deepEqual(requested, [
    'https://example.com/Mypractice/fr/src/styles/app.css?v=0.33.4',
    'https://example.com/Mypractice/frontline-roads/src/styles/app.css?v=0.33.4'
  ]);
});
